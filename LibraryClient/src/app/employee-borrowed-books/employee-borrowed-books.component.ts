...
@Component({
  ...
  templateUrl: "./employee-borrowed-books.component.html",
  styleUrls: ["./employee-borrowed-books.component.css"],
})
export class EmployeeBorrowedBooksComponent implements OnInit {
  constructor(
